...
Algorithm:
initialize hash to contain the key as the score for the letter,
 with the value an array of the letters for that score.
...
class Scrabble
  ...
  def score
    ...
    # Upcases, and cleans string of newline/tab characters
